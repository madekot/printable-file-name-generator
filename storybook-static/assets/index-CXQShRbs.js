    ...
    Me ||
      ...
      (function (n, a) {
        (function (o, i) {
          ...
          function X(e) {
            var t, r;
            return (r = (t = D.exec(e)) === null || t === void 0 ? void 0 : t[0]) !== null &&
              r !== void 0
              ? r
              : null;
          }
          ...
          function g(e) {
            const t = (r, s, c) => {
              ...
              } else if ("parseInfix" in e && e.precedence > s && e.accept(d, T))
          ...
          const z = g({
              ...
              parseInfix: (e, t) => (
                e.consume("="),
                { type: "JsdocTypeOptional", element: w(t), meta: { position: "suffix" } }
              ),
            }),
            Z = g({
              name: "numberParslet",
            ...
            Yt = g({
              ...
              parseInfix: (e, t) => (
                e.consume("!"),
                { type: "JsdocTypeNotNullable", element: w(t), meta: { position: "suffix" } }
              ),
            });
          ...
          const Wt = g({
            ...
            pe = [ce, z, Z, Bt, Ct, Yt, Gt({ allowTrailingComma: !0 }), Wt, Xt, z];
          function ee({ allowSquareBracketsOnAnyType: e, allowJsdocNamePaths: t, pathGrammar: r }) {
            return function (c, d, T) {
              ...
              switch (O.type) {
                case "JsdocTypeName":
                  M = { type: "JsdocTypeProperty", value: O.value, meta: { quote: void 0 } };
                  break;
                ...
                case "JsdocTypeStringValue":
                  M = { type: "JsdocTypeProperty", value: O.value, meta: { quote: O.meta.quote } };
                  break;
                ...
                if (!r.consume("}")) {
                  ...
                  for (;;) {
                    ...
                    r.acceptLexerState(d),
                      T === void 0 && t && (T = r.parseIntermediateType(f.OBJECT));
                    let J = !1;
                    if (
            ...
            return g({
              ...
              parseInfix: (c, d) => {
                ...
                if (
                  ...
                  const re = v.parseType(f.KEY_VALUE);
                  return (
          ...
          const Le = [
              ...
              $,
              te({ allowedTypes: ["module", "external", "event"], pathGrammar: V }),
              de({ allowEnclosingBrackets: !0, allowPostfix: !0 }),
              I({ allowedAdditionalTokens: ["keyof"] }),
              _e,
              Fe,
              ee({ allowSquareBracketsOnAnyType: !1, allowJsdocNamePaths: !0, pathGrammar: V }),
            ],
            Ht = [
              ...Le,
              me({
            ...
            je = g({
              ...
              parsePrefix: (e) => (
                e.consume("typeof"),
                { type: "JsdocTypeTypeof", element: w(e.parseType(f.KEY_OF_TYPE_OF)) }
              ),
            }),
            zt = [
            ...
            en = g({
              ...
              parsePrefix: (e) => {
                ...
                return (
                  e.consume("is"),
                  { type: "JsdocTypeAsserts", left: t, right: w(e.parseIntermediateType(f.INFIX)) }
                );
              },
            });
          ...
          const nn = g({
              ...
              parsePrefix: (e) => (
                e.consume("keyof"),
                { type: "JsdocTypeKeyof", element: w(e.parseType(f.KEY_OF_TYPE_OF)) }
              ),
            }),
            rn = g({
              name: "importParslet",
            ...
            an = g({
              ...
              parsePrefix: (e) => (
                e.consume("readonly"),
                { type: "JsdocTypeReadonlyProperty", element: e.parseType(f.KEY_VALUE) }
              ),
            }),
            on = g({
            ...
            un = [
              ...
              Fe,
              on,
              ee({ allowSquareBracketsOnAnyType: !0, allowJsdocNamePaths: !1, pathGrammar: V }),
              sn,
              ln,
...
var Je = Pn(),
  ...
  l = (n, a) => vn(n, "name", { value: a, configurable: !0 });
const { UnknownArgTypesError: Sn } = __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
    ...
    switch ((typeof o < "u" && (i.raw = o), n.name)) {
      ...
      case "union":
        return (p = n.elements) != null && p.every(kn)
          ? { ...i, name: "enum", value: (u = n.elements) == null ? void 0 : u.map(xn) }
          : { ...i, name: a, value: (y = n.elements) == null ? void 0 : y.map(Y) };
      case "intersection":
...
const { UnknownArgTypesError: _n } = __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
var Fn = l((n) => {
    switch (n.type) {
      case "function":
        return { name: "function" };
        ...
        return (
          (p = n.elements) != null && p.every((b) => b.name === "literal")
            ? (h = {
                ...i,
                name: "enum",
                value: (u = n.elements) == null ? void 0 : u.map((b) => Ye(b.value)),
              })
            : (h = { ...i, name: a, value: (y = n.elements) == null ? void 0 : y.map(G) }),
          h
        );
      case "intersection":
        return { ...i, name: a, value: (m = n.elements) == null ? void 0 : m.map(G) };
      default:
        return { ...i, name: "other", value: a };
    }
  }, "convert"),
...
function tt({ fence: n = "```" } = {}) {
  ...
  return l(function (i) {
    let p = [[]],
      u = !1;
    for (let y of i)
      Vn.test(y.tokens.description) && !u ? p.push([y]) : p[p.length - 1].push(y),
  ...
  return l(function (p) {
    ...
    if (
      (y.delimiter === "" &&
        ...
        !u.startsWith(a.end) &&
        ((y.delimiter = a.delim), (u = u.slice(a.delim.length)), ([y.postDelimiter, u] = j(u))),
      m)
    ) {
      let h = u.trimRight();
  ...
  return (o) => {
    ...
    for (let [m, [h, b]] of p.entries())
      (h.type = b),
        ...
        u.push(h.type);
    return (
      (u[0] = u[0].slice(1)), (u[u.length - 1] = u[u.length - 1].slice(0, -1)), (o.type = a(u)), o
    );
  };
}
l(st, "typeTokenizer");
...
l(Tt, "parse");
var Bn = { tags: ["param", "arg", "argument", "returns", "ignore", "deprecated"] },
  Cn = l((n, a = Bn) => {
...
function Pt({ name: n, raw: a, elements: o }) {
  return o != null ? E(o.map(xe).join(" | ")) : a != null ? E(a.replace(/^\|\s*/, "")) : E(n);
}
l(Pt, "generateUnion");
...
l(St, "generateObjectSignature");
function kt(n) {
  let { type: a } = n;
  return a === "object" ? St(n) : vt(n);
}
...
var Wn = l((n, a) => {
  ...
  return { name: n, type: At(a), required: i, description: o, defaultValue: It(a) };
}, "createTsPropDef");
function Rt(n) {
...
var sr = l((n) => {
  ...
  ar = ((n) => ((n.AUTO = "auto"), (n.CODE = "code"), (n.DYNAMIC = "dynamic"), n))(ar || {});
export {
  ke as B,
  We as Y,
  Et as a,
