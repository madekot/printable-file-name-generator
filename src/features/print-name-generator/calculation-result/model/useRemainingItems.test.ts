...
import * as lib from "@features/print-name-generator/calculation-result/lib/calculateRemainingItems";
import { Variant } from "@shared/types/variant";

jest.mock("@features/print-name-generator/calculation-result/lib/calculateRemainingItems");
